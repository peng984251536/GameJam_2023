...
[ExecuteAlways]
public class MyPlanarRef : MonoSingleton<MyPlanarRef>
{
    [Serializable]
    ...
    public void CloseCamera()
    {
        ...
        if (_reflectionCamera)
        {
            _reflectionCamera.gameObject.SetActive(false);
        }
    }
    public void OpenCamera()
    {
        ...
        if (_reflectionCamera)
        {
            _reflectionCamera.gameObject.SetActive(true);
        }
    }
    ...
    private void UpdateReflectionCamera(Camera realCamera)
    {
        ...
        Vector3 camPos = CameraManager.Instance.gameObject.transform.position;
        //修改虚拟摄像机的位置
        ...
        //关掉虚拟相机的模板测试
        _reflectionCamera.clearStencilAfterLightingPass = false;
