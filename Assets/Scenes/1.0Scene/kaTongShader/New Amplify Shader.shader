...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		[ASEBegin]_min("_min", Float) = 0.3
		_BaseColor01("_BaseColor01", Color) = (0,0.866,0,1)
		_max("_max", Float) = 0.7
		[ASEEnd]_c6362bfd0caa1aba03edca058a80688("c6362bfd0caa1aba03edca058a80688", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _BaseColor01;
			float4 _c6362bfd0caa1aba03edca058a80688_ST;
			float _min;
			float _max;
			...
			#endif
			CBUFFER_END
			sampler2D _c6362bfd0caa1aba03edca058a80688;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_c6362bfd0caa1aba03edca058a80688 = IN.ase_texcoord3.xy * _c6362bfd0caa1aba03edca058a80688_ST.xy + _c6362bfd0caa1aba03edca058a80688_ST.zw;
				float4 temp_output_24_0 = ( _BaseColor01 * tex2D( _c6362bfd0caa1aba03edca058a80688, uv_c6362bfd0caa1aba03edca058a80688 ) );
				float3 ase_worldNormal = IN.ase_texcoord4.xyz;
				float dotResult14 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float smoothstepResult16 = smoothstep( _min , _max , dotResult14);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( temp_output_24_0 * saturate( smoothstepResult16 ) ) + ( ( unity_AmbientGround * temp_output_24_0 ) * 7.0 ) ).rgb;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=A7DBC9927BEE2C990443CA11AC5A8E6E1E93A67C